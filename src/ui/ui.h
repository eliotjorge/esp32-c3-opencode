...
#include "../common/input_bus/input_bus.h"
    ...
    extern lv_obj_t *ui_shiftSwitch;
    void ui_event_shiftMode(lv_event_t *e);
    extern lv_obj_t *ui_shiftModeSelect;
    void ui_event_shiftBlinkRpm(lv_event_t *e);
    extern lv_obj_t *ui_shiftBlinkRpmSlider;
    extern lv_obj_t *ui_shiftBlinkRpmLabel;
    extern lv_obj_t *ui_shiftBlinkLabel;
    void ui_event_shiftFixedRpm(lv_event_t *e);
    extern lv_obj_t *ui_shiftFixedRpmSlider;
    extern lv_obj_t *ui_shiftFixedRpmLabel;
    extern lv_obj_t *ui_shiftPanel;
    extern lv_obj_t *ui_shiftModeLabel;
    void ui_event_ledCount(lv_event_t *e);
    extern lv_obj_t *ui_ledCountSlider;
    extern lv_obj_t *ui_ledCountLabel;
    void ui_event_ledMaxRpm(lv_event_t *e);
    extern lv_obj_t *ui_ledMaxRpmSlider;
    extern lv_obj_t *ui_ledMaxRpmLabel;
    void ui_event_ledTest(lv_event_t *e);
    extern lv_obj_t *ui_ledTestBtn;
    extern lv_obj_t *ui_ledTestLabel;
    extern lv_obj_t *ui_ledPanel;
